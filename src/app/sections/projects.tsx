    ...
    const projects = [
        {
            ...
            buttonText: "Github",
            link:"https://github.com/Burak849/reservationsystem",
        },
        {
            name: "Hotel SPA with RestApi",
            image: "media/hote-booking-ss.png",
            buttonText: "Github",
            link: "https://github.com/Burak849/hotel-booking",
        ...
        },
        {
            ...
            buttonText: "Github",
            link:"https://github.com/Burak849/auto-bio",
        },
        {
            ...
            buttonText: "Github",
            color: '#ff7171',
            link:"https://github.com/Burak849/doctors_referral",
        },
        {
            name: "Eventolog",
            ...
            buttonText: "Github",
            color: '#ff7171',
            link: "https://github.com/Burak849/event-creator",
        },
    ];
                        ...
                        <div className="card">
                            {projects.map((project, index) => (
                                <div className="cardItem" key={index} style={{ backgroundImage: `url(${project.image})` }}>
                                    ...
                                    <button type="button" className="btn-github" onClick={() => window.open(project.link, "_blank")}>
